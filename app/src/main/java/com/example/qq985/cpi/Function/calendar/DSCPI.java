...
public class DSCPI extends Fragment {
    ...
    private ImageView LeftButton;        //上一年
    private ImageView RightButton;       //下一年
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_dscpi, container, false);
    ...
    private void jumpStr(String str) {
        Intent intent = new Intent(getActivity(), CPIMainActivity.class);
    ...
    private void JanButton() {
        Jan = (Button) view.findViewById(R.id.buttonl);
    ...
    private void FebButton() {
        Feb = (Button) view.findViewById(R.id.buttonPane2);
    ...
    private void MarButton() {
        Mar = (Button) view.findViewById(R.id.buttonPane3);
    ...
    private void AprButton() {
        Apr = (Button) view.findViewById(R.id.buttonPane4);
    ...
    private void MayButton() {
        May = (Button) view.findViewById(R.id.buttonPane5);
    ...
    private void JunButton() {
        Jun = (Button) view.findViewById(R.id.buttonPane6);
    ...
    private void JulButton() {
        Jul = (Button) view.findViewById(R.id.buttonPane7);
    ...
    private void AugButton() {
        Aug = (Button) view.findViewById(R.id.buttonPane8);
    ...
    private void SepButton() {
        Sep = (Button) view.findViewById(R.id.buttonPane9);
    ...
    private void OctButton() {
        Oct = (Button) view.findViewById(R.id.buttonPanel0);
    ...
    private void NovButton() {
        Nov = (Button) view.findViewById(R.id.buttonPane1l);
    ...
    private void DecButton() {
        Dec = (Button) view.findViewById(R.id.buttonPanel2);
    ...
    //改变到当前年份的上一年
    private void left() {
        LeftButton = (ImageView) view.findViewById(R.id.imageButton);
    ...
    //改变到当前年份的下一年
    private void right() {
        RightButton = (ImageView) view.findViewById(R.id.imageButton2);
